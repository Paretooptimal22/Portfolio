        ...
        <Grid item xs={12} sm={8}>
          <Grid container direction="column">
            ...
            <Typography variant="h6" className={classes.paragraph}>
              Hello World and thank you for visiting my website!  
            </Typography>
            <br/>
            <Typography variant="h6" className={classes.paragraph}>
            ...
            <br/>
            <Typography variant="h6" className={classes.paragraph}>
              Anyways, feel free to browse my website.  You can also access my GitHub and LinkedIn pages by clicking on the icons in the navbar or on under my picture. Thanks again! - Kevin
            </Typography>
          </Grid>
        </Grid>
      </Grid>
